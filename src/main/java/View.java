...
public class View {
    ...
    public static void view() {
        ...
        step++;
        Main.team1.forEach((v) -> l[0] = Math.max(l[0], v.getInfo().length()));
        Main.team2.forEach((v) -> l[0] = Math.max(l[0], v.getInfo().length()));
